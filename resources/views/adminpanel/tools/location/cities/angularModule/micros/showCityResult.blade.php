...
<div class="row">
	...
	<div class="col-md-3">
		...
		<input type="number" min="0"  step="1" ng-model="startRow" name="" class="form-control">
		  </div>
		  <div class="col-md-3">
		  <label>Search:</label>
	...
	<table id="city_result_table" class="table table-striped table-bordered">
        ...
        <br><br>
			...
			<tr ng-repeat="city in cities|filter:search1|limitTo:rowLimit:startRow|orderBy:sortColumn:reverseSort">
				...
				<td><%city.name%></td>	
				<td><button class="edit btn btn-primary" id="show_city_form" ng-click="showEditCityForm(city.id,city.name,city.district_id,city.sub_region_id);">Edit</button></td>
				<td><button class="edit btn btn-danger" ng-click="deleteCity(city.id)">Delete</button></td>				
			</tr>
