...
@section('content')
<div ng-app="manageStates" ng-controller="StateController">
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="col-md-1 col-md-offset-10">
              <button ng-click="showAddNewStateForm()" class="btn btn-success ">Add State</button>
            </div>
            ...
            <div id='page-city-content'>
             	@include('adminpanel.tools.location.states.angularModule.micros.showStateResult')
              @include('adminpanel.tools.location.states.angularModule.micros.EditStateForm')
            </div>
              @include('adminpanel.tools.location.states.angularModule.micros.AddNewState')
...
<script src="{{URL::asset('js/adminPanelJsFiles/State.js')}}"></script>  
